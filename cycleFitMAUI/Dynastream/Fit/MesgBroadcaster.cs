...
namespace Dynastream.Fit
{
    ...
    public class MesgBroadcaster
    {
        ...
        public event MesgEventHandler MonitoringHrDataMesgEvent;
        
        public event MesgEventHandler Spo2DataMesgEvent;
        
        public event MesgEventHandler HrMesgEvent;
        
        public event MesgEventHandler StressLevelMesgEvent;
        
        public event MesgEventHandler MaxMetDataMesgEvent;
        
        public event MesgEventHandler MemoGlobMesgEvent;
        
        public event MesgEventHandler SleepLevelMesgEvent;
        ...
        public event MesgEventHandler BeatIntervalsMesgEvent;
        
        public event MesgEventHandler HrvStatusSummaryMesgEvent;
        
        public event MesgEventHandler HrvValueMesgEvent;
        
        public event MesgEventHandler RespirationRateMesgEvent;
        ...
        public void OnMesg(object sender, MesgEventArgs e)
        {
            ...
            case (ushort)MesgNum.MonitoringHrData:
                if (MonitoringHrDataMesgEvent != null)
                {
                    MonitoringHrDataMesg monitoringHrDataMesg = new MonitoringHrDataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = monitoringHrDataMesg;
                    MonitoringHrDataMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.Spo2Data:
                if (Spo2DataMesgEvent != null)
                {
                    Spo2DataMesg spo2DataMesg = new Spo2DataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = spo2DataMesg;
                    Spo2DataMesgEvent(sender, mesgEventArgs);
                }
                break;
            ...
            case (ushort)MesgNum.MaxMetData:
                if (MaxMetDataMesgEvent != null)
                {
                    MaxMetDataMesg maxMetDataMesg = new MaxMetDataMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = maxMetDataMesg;
                    MaxMetDataMesgEvent(sender, mesgEventArgs);
                }
                break;
            ...
            case (ushort)MesgNum.SleepLevel:
                if (SleepLevelMesgEvent != null)
                {
                    SleepLevelMesg sleepLevelMesg = new SleepLevelMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = sleepLevelMesg;
                    SleepLevelMesgEvent(sender, mesgEventArgs);
                }
                break;
            ...
            case (ushort)MesgNum.BeatIntervals:
                if (BeatIntervalsMesgEvent != null)
                {
                    BeatIntervalsMesg beatIntervalsMesg = new BeatIntervalsMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = beatIntervalsMesg;
                    BeatIntervalsMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.HrvStatusSummary:
                if (HrvStatusSummaryMesgEvent != null)
                {
                    HrvStatusSummaryMesg hrvStatusSummaryMesg = new HrvStatusSummaryMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = hrvStatusSummaryMesg;
                    HrvStatusSummaryMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.HrvValue:
                if (HrvValueMesgEvent != null)
                {
                    HrvValueMesg hrvValueMesg = new HrvValueMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = hrvValueMesg;
                    HrvValueMesgEvent(sender, mesgEventArgs);
                }
                break;
            
            case (ushort)MesgNum.RespirationRate:
                if (RespirationRateMesgEvent != null)
                {
                    RespirationRateMesg respirationRateMesg = new RespirationRateMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = respirationRateMesg;
                    RespirationRateMesgEvent(sender, mesgEventArgs);
                }
                break;
            ...
            case (ushort)MesgNum.SleepAssessment:
                if (SleepAssessmentMesgEvent != null)
                {
                    SleepAssessmentMesg sleepAssessmentMesg = new SleepAssessmentMesg(e.mesg);
                    MesgEventArgs mesgEventArgs = new MesgEventArgs();
                    mesgEventArgs.mesg = sleepAssessmentMesg;
                    SleepAssessmentMesgEvent(sender, mesgEventArgs);
                }
                break;
